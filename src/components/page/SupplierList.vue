  ...
  export default {
    ...
    methods: {
      ...
      getData() {
        ...
        this.$axios.post('/admin/web/supplier', {
      ...
      doImport() {
        ...
        this.$axios.post('/admin/api/supplier', formData).then((res) => {
          let result = res.data;
          if (result.code==200) {
      ...
      doExport() {
        ...
        this.$axios.post('/admin/file/supplier/?export_model=retailer_data', config).then((res) => {
      ...
      saveEdit() {
        this.$axios.defaults.headers.common['token'] = localStorage.getItem('token');
        this.$axios.put('/admin/api/supplier', {
          id: this.form.id,
          name: this.form.name,
      ...
      deleteRow() {
        ...
        this.$axios.delete('/admin/api/supplier', config).then((res) => {
          let result = res.data;
          if (result.code==200) {
            //this.$set(this.tableData, this.idx, this.form);
